	  ...
	  <div class="container">
		  <div class="row justify-content-center">
			  ...
			  <div class="col-md-10 mb-5 text-center">
				...
				<li><a href="{{URL::to('/shop')}}" class="{{ request(
					)->is('shop')? 'active' : '' }}">All</a></li>
					@foreach ($category as $category)
				<li><a href="/view_by_cat/{{$category->category_name}}"   class="{{ request(
					)->is('view_by_cat/'.$category->category_name)? 'active' : '' }}">{{$category->category_name}}</a></li>
					@endforeach
				</ul>
